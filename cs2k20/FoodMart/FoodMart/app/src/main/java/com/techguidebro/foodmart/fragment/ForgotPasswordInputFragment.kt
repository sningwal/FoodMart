...
class ForgotPasswordInputFragment(val contextParam: Context) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_change_password_input, container, false)
        editTextMobileNumber = view.findViewById(R.id.editTextMobileNumber)
        editTextEmail = view.findViewById(R.id.editTextEmail)
        buttonNext = view.findViewById(R.id.buttonNext)
        forgot_password_input_fragment_Progressdialog =
            view.findViewById(R.id.forgot_password_input_fragment_Progressdialog)
                        ...
                        try {
                            ...
                            val jsonObjectRequest = object : JsonObjectRequest(
                                ...
                                Response.Listener {
                                    ...
                                    forgot_password_input_fragment_Progressdialog.visibility =
                                        View.INVISIBLE
                                },
